        ...
        <div id="tete-site">
            ...
            <nav class="menu-nav" align="right" valign="middle">
                <ul>
                    ...
                    <li class="btn">
                        <a href="programmer.php">Programmes personnalisé</a>
                    </li>
                    <li class="btn">
                        <a href="#portfolio">Limitation du client</a>
                    </li>
    ...
    <div id="contenu-site">
        <section class="accueil reveal" id="accueil">
            <div class="accueilcontent" align="center">
                <h1 class="autotext text9 noir gras">Expert en module WHMCS</h1>
            </div>
        </section>
        <section class="info reveal" id="info">
            <div class="infocontent" align="center">
                <div class="info">
                    <h2 class="text7 reveal-1">Services</h2>
                    <div class="grid-service">
                        <div class="service">
                            ...
                            <div class="textservice">
                                ...
                                <h4>Si vous recherchez une intégration de la plus haute qualité avec votre conception Web,
                        ...
                        <div class="service">
                            ...
                            <div class="textservice">
                                ...
                                <h4>Les services WHMCS fournissent des modules / modules complémentaires qui, selon eux,
                        ...
                        <div class="service">
                            ...
                            <div class="textservice">
                                ...
                                <h4>Nous avons de l'expérience dans le développement de modules de serveur personnalisés,
                        ...
                        <div class="service">
                            ...
                            <div class="textservice">
                                ...
                                <h4>Websoftsolus reconnaît la nécessité d'avoir un bon programme d'affiliation honnête
        ...
        <section class="a-propos" id="a-propos">
            <div class="a-propos">
                ...
                <div class="textservice">
                    ...
                    <h4>Websoftsolus vous propose uniquement des modules et des modules/addons personnalisés de la plus haute qualité.
        ...
        <section class="contact" id="contact">
            <div class="contactcontent" align="center">
                <h2 class="text7 soulignes reveal-1" align="center">
                ...
                <div class="reveal" id="form-ctt">
                    <form class="form-ctt" method="post" role="form">
                        <div class="contenu-form reveal-1">
                            ...
                            <p class="etoile" align="center">* Ces informations sont requise</p>
                            <div align="center">
